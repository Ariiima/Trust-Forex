#!/bin/sh
# Ship the landing pages (Cashback, Results, Referral, About, Broker Partnership, Partner Brokers, Blog) and their runtime dependencies under /v/.
...
COPYFILE_DISABLE=1 tar czf - --no-xattrs --exclude='.DS_Store' \
    index.html cb8 results referral about partnership brokers blog shared/scale.css \
...
for p in landing/ landing/cb8/ landing/results/ landing/referral/ landing/about/ landing/partnership/ landing/brokers/ landing/blog/; do
